    ...
    ***************************************************************************** */
    ...
    ReduxedStorage.prototype.init = function init () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.tmstamp || this.isolated ||
                this.storage.subscribe(function (data) { return __awaiter(this$1$1, void 0, void 0, function* () {
                    ...
                    if (id === this.id || isEqual(state, this.state))
                        { return; }
                    var newTime = timestamp >= this.tmstamp;
                    if (!newTime)
                        { return; }
            ...
            return new Promise(function (resolve) {
                this$1$1.storage.load(function (data) { return __awaiter(this$1$1, void 0, void 0, function* () {
                    var ref = unpackState(data);
    ...
    ReduxedStorage.prototype._renewStore = function _renewStore () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var store = this.store = yield this._instantiateStore(this.state);
            var now = Date.now();
            ...
            var unsubscribe = this.store.subscribe(function () { return __awaiter(this$1$1, void 0, void 0, function* () {
                var state = store && store.getState();
                var sameStore = this.store === store;
                this._clean();
    ...
    ReduxedStorage.prototype._instantiateStore = function _instantiateStore (state) {
        return __awaiter(this, void 0, void 0, function* () {
            var store = yield this.container(state);
    ...
    function setupReduxed(storeCreatorContainer, options, listeners) {
        ...
        typeof onGlobalChange === 'function' &&
            storage.regListener(function (data, oldData) { return __awaiter(this$1$1, void 0, void 0, function* () {
